...
const AverageSellingProduct = () => {
  ...
  return (
    ...
    <Breadcrumb.Divider />
    <Breadcrumb.Section active>Average Selling Price</Breadcrumb.Section>
      ...
      <input type="submit" value="Submit" />
              ...
              <CTable  className="mb-0 border" hover responsive style={{width:'10%'}}>
                ...
                <CTableBody>
                  {salesForComputer &&salesForComputer.map((item, index) => (
...
<br></br>
              <CTable  className="mb-0 border" hover responsive style={{width:'10%'}}>
                ...
                <CTableBody>
                  {salesForLaptop &&salesForLaptop.map((item, index) => (
                    <CTableRow v-for="item in tableItems" key={index}>
                      <CTableDataCell className="text-center">
...
<br></br>
              <CTable  className="mb-0 border" hover responsive style={{width:'10%'}}>
                ...
                <CTableBody>
                  {salesForPrinter &&salesForPrinter.map((item, index) => (
                    <CTableRow v-for="item in tableItems" key={index}>
                      <CTableDataCell className="text-center">
