...
WHERE DATE(TDATE)>='2022-01-01' AND DATE(TDATE)<='2023-01-01' AND TTag='Delivered'
GROUP BY PID
ORDER BY SOLD_TIMES;
...
SELECT CID,PID FROM appears_in NATURAL JOIN transactions WHERE DATE(TDATE)>='2022-01-01' AND DATE(TDATE)<='2023-01-01' AND TTag='Delivered';
